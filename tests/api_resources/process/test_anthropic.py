...
class TestAnthropic:
    ...
    def test_method_retrieve(self, client: Deco) -> None:
        anthropic = client.process.anthropic.retrieve(
            0,
        )
    ...
    def test_raw_response_retrieve(self, client: Deco) -> None:
        response = client.process.anthropic.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: Deco) -> None:
        with client.process.anthropic.with_streaming_response.retrieve(
            0,
        ) as response:
...
class TestAsyncAnthropic:
    ...
    async def test_method_retrieve(self, async_client: AsyncDeco) -> None:
        anthropic = await async_client.process.anthropic.retrieve(
            0,
        )
        assert_matches_type(object, anthropic, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncDeco) -> None:
        response = await async_client.process.anthropic.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncDeco) -> None:
        async with async_client.process.anthropic.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
