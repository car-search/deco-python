...
class Deco(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Deco client instance.

        This automatically infers the `api_key` argument from the `DECO_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("DECO_API_KEY")
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("DECO_BASE_URL")
        if base_url is None:
            base_url = f"https://api.example.com"

        custom_headers_env = os.environ.get("DECO_CUSTOM_HEADERS")
    ...
    def with_raw_response(self) -> DecoWithRawResponse:
        return DecoWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> DecoWithStreamedResponse:
        return DecoWithStreamedResponse(self)
...
class AsyncDeco(AsyncAPIClient):
    # client options
    api_key: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncDeco client instance.
    ...
    def process(self) -> AsyncProcessResource:
        from .resources.process import AsyncProcessResource
    ...
    @cached_property
    def with_streaming_response(self) -> AsyncDecoWithStreamedResponse:
        return AsyncDecoWithStreamedResponse(self)
...
class DecoWithRawResponse:
    _client: Deco

    def __init__(self, client: Deco) -> None:
        self._client = client

    @cached_property
    def process(self) -> process.ProcessResourceWithRawResponse:
        from .resources.process import ProcessResourceWithRawResponse
...
class AsyncDecoWithRawResponse:
    ...
    def __init__(self, client: AsyncDeco) -> None:
        self._client = client

    @cached_property
    def process(self) -> process.AsyncProcessResourceWithRawResponse:
...
class DecoWithStreamedResponse:
    ...
    @cached_property
    def process(self) -> process.ProcessResourceWithStreamingResponse:
        from .resources.process import ProcessResourceWithStreamingResponse
...
class AsyncDecoWithStreamedResponse:
    ...
    @cached_property
    def process(self) -> process.AsyncProcessResourceWithStreamingResponse:
