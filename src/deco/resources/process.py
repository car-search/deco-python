...
class ProcessResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ProcessResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/deco-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ProcessResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/deco-python#with_streaming_response
        """
